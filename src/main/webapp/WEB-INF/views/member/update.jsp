...
<div class="page-content">
    <div class="form-v10-content">
        <form class="form-detail" action="/member/update" method="post" enctype="multipart/form-data">
            <div class="form-left">
                <h2 style="color: dimgrey">사원정보</h2>
                <div class="form-row">
                    <input type="text" name="memberId" id="memberId" class="input-text" value="${memberDTO.memberId}" readonly>
                </div>
                <div class="form-row">
                    <input type="password" name="memberPassword" id="memberPassword" value="${memberDTO.memberPassword}" class="input-text" required>
                </div>
                <div class="form-row">
                    <input type="text" name="memberName" id="memberName" class="input-text" value="${memberDTO.memberName}" readonly>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    <input type="text" name="salary" class="company" id="salary" value="${memberDTO.salary}" required>
                </div>
                <div class="form-row">
                    <input type="text" name="career" class="company" id="career" value="${memberDTO.career}" required>
                </div>
                <div class="form-row">
            ...
            <div class="form-right">
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="memberIdNum" class="company" id="memberIdNum" value="${memberDTO.memberIdNum}" readonly>
                </div>
                <div class="form-row">
                    <input type="text" name="MemberBirthDay" class="company" id="birthDay" value="${memberDTO.memberBirthDay}" readonly>
                </div>
                <div class="form-row">
                    <input type="text" name="memberAddress" class="company" id="address" value="${memberDTO.memberAddress}" required>
                </div>
                <div class="form-row">
                    <input type="text" name="educationLv" class="company" id="educationLv" value="${memberDTO.educationLv}" required>
                </div>
                <div class="form-row">
                    <input type="text" name="certificate" class="company" id="certificate" value="${memberDTO.certificate}">
                </div>
                <div class="form-row">
                    <input type="text" name="memberMobile" class="phone" id="mobile" value="${memberDTO.memberMobile}" maxlength="11"required>
                </div>
                <div class="form-row">
                    <input type="text" name="memberEmail" id="your_email" class="input-text" value="${memberDTO.memberEmail}" required>
                </div>
                <div class="form-row-last">
                    <input type="submit" name="register" class="register" value="정보수정" >
                </div>
            </div>
        </form>
    </div>
